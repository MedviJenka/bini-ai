...
class PipelineInput(BaseModel):
    ...
    agent_name:   str = Field(..., description="Name of the agent or skill being documented")
    skill_name:   str = Field(..., description="Name of the skill being documented")
    command_name: str = Field(..., description="Name of the command being documented")
